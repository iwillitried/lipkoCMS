...
function show_edit_modal(e) {
  ...
  var modal_container_content = `<div class="modal_header"><h1 class="modal_headline">${modal_headline}</h1><div class="modal_close_button">x</div></div><div class="modal_body"><div class="modal_body_left"><h2>Name</h2><input type="text" name="modal_input_name" value="${current_entry.name}">${showK ? "" : modal_land_section}</div><div class="modal_body_right"><h2>Verknüpfte ${(!showK?"Kunden":"Hersteller")}</h2><div class="modal_body_right_scrollbox"><div class="scrollbox_included"></div><hr class="solid"><div class="scrollbox_excluded"></div></div><div class="modal_body_right_searchbox"><div></div><input class="modal_searchbar" type="text" name="" value="" placeholder="Suchen oder neu erstellen"><!-- <div></div> --><div class="modal_include_button modal_searchbar_button modal_button_animation"></div><!-- <div></div> --></div><div></div><div class="modal_body_right_buttonbox"><button class="red_button modal_button modal_button_animation" name="button">${modal_cancel_button_text}</button><button class="blue_button modal_button modal_button_animation" name="button">${modal_save_button_text}</button></div></div></div>`;
...
function show_add_modal() {
  ...
  var modal_land_section = '<h2>Land</h2><input type="text" name="modal_input_name" value="" placeholder="(optional)"><p>Die Kombination aus Name und Land sollte den Hersteller eindeutig beschreiben. Beides kann nach dem Erstellen jederzeit angepasst werden.</p>';
  var modal_container_content = `<div class="modal_header"><h1 class="modal_headline">${modal_headline}</h1><div class="modal_close_button">x</div></div><div class="modal_body"><div class="modal_body_left"><h2>Name</h2><input type="text" name="modal_input_name" value="">${showK ? "" : modal_land_section}</div><div class="modal_body_right"><h2>Verknüpfte ${(!showK?"Kunden":"Hersteller")}</h2><div class="modal_body_right_scrollbox"><div class="scrollbox_included"></div><hr class="solid"><div class="scrollbox_excluded"></div></div><div class="modal_body_right_searchbox"><div></div><input class="modal_searchbar" type="text" name="" value="" placeholder="Suchen oder neu erstellen"><!-- <div></div> --><div class="modal_include_button modal_searchbar_button modal_button_animation"></div><!-- <div></div> --></div><div></div><div class="modal_body_right_buttonbox"><button class="blue_button modal_button modal_button_animation" name="button">${modal_save_button_text}</button></div></div></div>`;
